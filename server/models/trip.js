  ...
  trip.init(
    {
      startDate: {
        ...
        validate: {
          ...
          isAfter: {
            args: trip.yesterday().toDateString(),
            msg: ' vous ne pouvez pas insére un voyage dans une date expiré',
          },
        },
      },
      endDate: {
        ...
        validate: {
          ...
          notLowerThanStartDate(value) {
            if (value < this.startDate)
              throw new Error(
                "la date d'arrivée doit être supérieur ou égale à la date de départ"
              )
          },
        },
      },
